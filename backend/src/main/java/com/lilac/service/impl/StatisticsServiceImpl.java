...
public class StatisticsServiceImpl implements StatisticsService {
    ...
    private Double calculateSuccessRate() {
        ...
        QueryWrapper successWrapper = QueryWrapper.create().eq("status", ArticleStatusEnum.COMPLETED.getValue());
    ...
    private Long calculateQuotaUsed() {
        ...
        QueryWrapper normalUserWrapper = QueryWrapper.create().eq("userRole", UserConstant.DEFAULT_ROLE);
