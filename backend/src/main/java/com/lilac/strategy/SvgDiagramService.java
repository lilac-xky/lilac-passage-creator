...
import com.lilac.config.SvgDiagramConfig;
...
import static com.lilac.constant.ArticleConstant.PICSUM_URL_TEMPLATE;
...
public class SvgDiagramService implements ImageSearchService {
    ...
    private boolean isValidSvg(String svgCode) {
        return svgCode.startsWith("<?xml") && svgCode.contains("<svg");
    }
